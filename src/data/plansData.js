const plansData = [
  ...
  },
  {
    name: "Standard",
    price: "$9.99/Month",
    features: ["Access to all movies and TV shows", "Shared account for up to 3 people"],
  ...
  },
  {
    name: "Superstar",
    price: "$19.99/Month",
    features: ["VIP access with early episodes and movies.", "Up to 5 people per account."],
    classes: "border-yellow-400 bg-yellow-50 h-96 shadow-xl hover:scale-105 hover:shadow-2xl",
